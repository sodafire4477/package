 ...
 */
class Cradle_Package_Config_ConfigPackage_Test extends TestCase
{
  /**
   * @var EventPackage
   */
  ...
  /**
   * @covers Cradle\Package\Config\ConfigPackage::set
   * @covers Cradle\Package\Config\ConfigPackage::get
   * @covers Cradle\Package\Config\ConfigPackage::exists
   */
